...
<body style="background-color:rosybrown;">
        ...
        <ul>
            <li class="dropdown" onclick="toggleDisplay('1')">
                ...
                <div class="dropdown-content" id="1">
                    ...
                    <a href="manage_classes.php">Show Semesters</a>
                </div>
            </li>
    ...
    <div class="main">
        <form action="" method="post">
            <fieldset>
                <legend>Add Sem Details</legend>
                <input type="text" name="Sem" placeholder="Enter Sem">
                <input type="text" name="id" placeholder="Enter Sem ID">
...
<?php 
    ...
    if (isset($_POST['Sem'],$_POST['id'])) {
        ...
        $sql = "INSERT INTO `Semester` (`Sem`, `id`) VALUES ('$name', '$id')";
